...
def clean_data():
    ...
    * precio: precio de la electricidad en la bolsa nacional
    ...
    """
    """se crea un archivo único de los archivos ya transformados en csv de la carpeta raw y se realiza la transformación de la fecha y hora en el formato indicado"""
